...
> **已对齐**：`README.md`（仓库根）、`面试背诵稿.md`、`resume-项目一.md`、`开发过程中遇到的问题.md`、ch09、`项目详解.md`（2026-09-14）。
...
> （`项目详解.md` 的**评测口径**已对齐，但它的「用户看到的是什么」一节仍只描述四阶段面板，未涵盖 Phase 1B 新增的问答模式 —— 见 `journal/未完成清单.md` 的 B5。）
